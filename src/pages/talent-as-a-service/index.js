      ...
      <CustomLayout link={"talent-as-a-service"}>
          ...
          <Row gutter={[24, 24]}>
            <Col xs={24} sm={12} className={styles["box-1-left"]}>
              <p className={styles["grey-text"]}>
                {" "}
                ROCKSHIP STAFFING SERVICE PAGE{" "}
              </p>
              <p className={styles["key-message"]}>
                {" "}
                Search for skilled engineers globally
              </p>
              <div className={styles["contents-box"]}>
                <div className={styles["contents"]}>
                  ...
                  <p className={styles["sub-text"]}>
                    {" "}
                    Hire on-demand our full-time staff for a task or project you
                    want to complete quickly.
                  </p>
                </div>
                <div className={styles["contents"]}>
                  <ul>
                    We have screened the on-demand staffs rigorously so that it
                    is smooth to work directly with them.
                  </ul>
                </div>
                ...
                <div className={styles["contents"]}>
                  ...
                  <p className={styles["sub-text"]}>
                    {" "}
                    Plan for your engineering team expansion within 3 months by
                    sharing the hiring plan.
                  </p>
                </div>
              </div>
              <Col xs={0} sm={24}>
            ...
            <Col xs={24} sm={12} className={styles["col"]}>
              <div className={styles["robot-hands"]}>
                <img src="/global-engineers-graph.png" alt="robot-hands" />
              </div>
            </Col>
          </Row>
        </div>
        <div className={styles["box-4"]}>
          <div className={styles["box-AI-Stack"]}>
            <h3>Why Rockship? </h3>
            <img src="/why-rockship-2x.png" alt="Why Rockship?" />
          </div>
        </div>
      </CustomLayout>
    </>
