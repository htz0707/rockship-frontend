          ...
          <Row>
            ...
            >
              ...
              <div className={styles["contents"]}>
                <img src="/tick.svg" alt="tick" />
                <p>
                  Implement caching of requests to LLMs to help you save cost on
                  your chatbot.
                </p>
              </div>
              <div className={styles["contents"]}>
          ...
          <Row gutter={[24, 24]} className={styles["box-GenAI"]}>
            <Col xs={24} sm={24}>
              ...
              <p>
                ...
                insights collected from running the content campaign can improve
                the content research project. Our system also support various
                formats of the content to be suitable to be listed on the
                communities in various social media platforms.
              </p>
            </Col>
            <Col xs={0} sm={24}>
