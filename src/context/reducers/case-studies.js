...
const initialState = {
  caseStudies: [
      ...
      mains: [
        {
          ...
          data: [
            { id: 1, name: "Customer relationship management (CRM): Provide fitness business owners with a comprehensive set of features to efficiently enhance customer relationships including:" },
            { id: 2, name: "Facility bookings: Allows fitness business owners to create and manage their facilities. This platform also facilitates sport players in easily discovering and reserving facilities based on their individual demands." }
          ]
        },
        {
          id: 2,
      ...
      mains: [
        {
          ...
          content: "This module covers a wide range of primary school math skills, including numbers and counting, fractions, decimals, shapes, and more. It serves as a valuable resource for students to engage in math homework, facilitating practice and advancement in their mathematical proficiency.",
    ...
    },
    {
      ...
      duration: "Ongoing",
      program: "App",
      description: "Rockship has introduced a groundbreaking solution in the form of a mobile app: Mei Mei. This app utilizes facial scanning technology to assess your face and provide recommendations on the necessary cosmetic procedures to enhance your appearance. ",
      hashtags: [
        { id: 1, name: "face-scan" },
    ...
    },
    {
      ...
      duration: "24 months",
      program: "App",
      description: "Meta is a free gaming social network platform. Meta synthesizes some popular game such as Dota, Mobile Legends for gamers to make friends and team up against each other. ",
      hashtags: [
      ...
      solutions: ["Rockship engaged the services of two software engineers with the objective of delivering the frontend component of the Meta.us platform. Additionally, our team extended further support by providing a backend developer to strengthen the Python infrastructure for Meta.us.", "We provide our support to the Meta.us team by allocating engineers who are responsible for delivering the following features:"],
      mains: [
        {
          id: 1,
        ...
        },
        {
          id: 4, 
          title: "", 
          content: ["We maintain a close and collaborative relationship with our client, conducting meetings twice a week to ensure effective communication and progress tracking. Our dedicated engineers diligently provide daily updates and commit code regularly to the client's repository. The client's appointed Technical Lead thoroughly reviews and merges the code changes."
          ], 
        }, 
        {
          id: 5, 
          title: "", 
          content: ["Our engineers take significant ownership in the testing and verification process, thereby eliminating the necessity for a dedicated Quality Assurance team. This proactive approach ensures the project's overall quality and timely delivery."
          ], 
        }
      ],
      highlights: [
